...
class Popup():
    def __init__(self, win_width, win_height):
      ...
      question_layout_rect = pygame.Rect(ui_window_padding/2, ui_window_padding/2, win_width - ui_window_padding, win_height - ui_window_padding)
      self.ui_window = pygame_gui.elements.UIWindow(rect = question_layout_rect,
